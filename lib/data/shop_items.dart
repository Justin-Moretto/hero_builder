...
List<ItemModel> get shopItemPool => [
      ...
      const ItemModel(key: 'short_sword', name: 'Short Sword', damage: 4, cost: 10, cooldown: 1.2, slotType: ItemSlotType.weapon),
      ...
      const ItemModel(key: 'rapier', name: 'Rapier', damage: 3, cost: 11, cooldown: 0.6, slotType: ItemSlotType.weapon),
      ...
      const ItemModel(key: 'long_sword', name: 'Long Sword', damage: 7, cost: 18, cooldown: 1.5, slotType: ItemSlotType.weapon, isTwoHanded: true),
      const ItemModel(key: 'battle_axe', name: 'Battle Axe', damage: 9, cost: 22, cooldown: 2.0, slotType: ItemSlotType.weapon, isTwoHanded: true),
      // Consumables
      const ItemModel(
        key: 'health_potion',
        name: 'Health Potion',
      ...
      // Armor
      const ItemModel(key: 'leather_armor', name: 'Leather Armor', damage: 0, cost: 12, cooldown: 0.0, slotType: ItemSlotType.armor),
      const ItemModel(key: 'chain_armor', name: 'Chain Armor', damage: 0, cost: 20, cooldown: 0.0, slotType: ItemSlotType.armor),
    ];
